    ...
    return (
            <div className="top-0 w-full md:w-full lg:w-3/12 lg:h-screen lg:sticky bg-gray-100">
               ...
               <div className="py-10 mt-16 text-center px-5 h-screen relative">
                    ...
                    <img src="images/profile-photo-demo.jpeg" alt="Profile Image" 
                        className="rounded-full m-auto mb-5"/>                
                    
                    <h1 className=" text-blue-900 text-2xl mb-2">Mridul Bhattacharjee</h1>                
                    <h4 className="text-blue-900 mb-8">Full Stack Web Developer</h4>                
                    
                    <p className="text-gray-600 mb-5">
                        Lorem ipsum dolor sit amet, consec tetur adipisicing elit, sed do eius tempor incididunt.
                    </p>

                    <button className="bg-white shadow-md hover:text-blue-700 text-blue-900 py-3 px-6">
                        Learn More
                    </button>
